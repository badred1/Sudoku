...
void jouer(SDL_Surface* ecran,int numero,int difficulte)
{
    ...
    deux=IMG_Load("2.png");
    trois=IMG_Load("3.png");
    quatre=IMG_Load("4.png");

    fond=IMG_Load("JEU.png");
    ...
    while (continuer)
    {
        ...
        case SDL_MOUSEBUTTONDOWN:
            ...
            if ((event.button.x>259&& event.button.x<566)&&(event.button.y>654 && event.button.y<754))
            {
            ...
            if ((event.button.x>617&& event.button.x<773)&&(event.button.y>580 && event.button.y<743))
